function [directivity] = softBaffle(frequency_range, angle_range, element_radius, sound_speed)
    %softBaffle calculates soft baffled models.
    %
    % DESCRIPTION:
    %     softBaffle calculates the directional response of hydrophones
    %     using the piston in a soft-baffled model.
    %
